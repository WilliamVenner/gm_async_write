...
pub const LUA_TBOOLEAN: LuaInt = 1;
...
pub struct LuaShared {
	...
	pub lual_checktype: Symbol<'static, unsafe extern "C-unwind" fn(state: LuaState, arg: LuaInt, t: LuaInt)>,
	pub lua_toboolean: Symbol<'static, unsafe extern "C-unwind" fn(state: LuaState, arg: LuaInt) -> LuaInt>,
}
