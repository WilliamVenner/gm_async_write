...
impl LuaState {
	...
	#[inline]
	pub unsafe fn is_boolean(&self, index: LuaInt) -> bool {
	...
	#[inline]
	pub unsafe fn to_boolean(&self, arg: LuaInt) -> bool {
		(LUA_SHARED.lua_toboolean)(*self, arg) == 1
	}

	#[inline]
	pub unsafe fn check_type(&self, arg: LuaInt, t: LuaInt) {
		(LUA_SHARED.lual_checktype)(*self, arg, t)
	}

	#[inline]
	pub unsafe fn check_function(&self, arg: LuaInt) {
